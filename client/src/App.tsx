...
function ProductImage({ product, compact = false }: { product: Product; compact?: boolean }) {
  if (product.imageUrl) {
    const zoom = Math.min(3, Math.max(1, Number(product.imageZoom ?? 1)));
