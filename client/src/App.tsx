...
type FiscalReadiness = {
  ...
  notice: string;
  records: Array<{ id: number; invoiceNumber: string; recordType: string; chainPosition: number; algorithm: string; previousHash: string | null; recordHash: string; submissionStatus: string; submissionMessage: string | null; generatedAt: string; totalAmount: string }>;
};
  ...
  return (
    <main className="admin-shell">
      ...
      <section className="admin-content">
        ...
        {tab === "fiscal" && <FiscalReadinessPanel data={fiscalQuery.data} loading={fiscalQuery.isLoading} verifying={fiscalVerifyMutation.isPending} onVerify={() => fiscalVerifyMutation.mutate()} />}
