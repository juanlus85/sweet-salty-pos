...
function buildSalesRanges(from: string, to: string) {
  ...
  const start = from ? new Date(`${from}T00:00:00.000`) : new Date(end.getTime() - (DEFAULT_SALES_LOOKBACK_DAYS - 1) * 24 * 60 * 60 * 1000);
